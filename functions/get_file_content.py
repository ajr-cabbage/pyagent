...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="Returns the contents of a file in a specified file path, relative to the working directory.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="File path to the file that is to be read, relative to the working directory.",
            ),
        },
        required=["file_path"],
    ),
